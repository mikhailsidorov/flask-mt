...
def messages():
    ...
    next_url = url_for('main.messages', page=messages.next_num) if message.has_next else None
    prev_url = url_for('main.messages', page=messages.prev_num) if message.has_prev else None
